...
private let data = ["Food", "Grocery", "Beauty", "Lifestyle", "Baby&kids", "Clothing", "Furniture", "Accessory"]
class DetailViewController: ExpandableViewController {
...
extension DetailViewController : CustomTableViewCellDelegate {
